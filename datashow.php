  ...
  <style>
    ...
    /* form */
        ...
        .form-section {
            ...
            align-items: center;
            display: flex;
            box-shadow: inset 0 0 10px rgba(7, 7, 7, 0.34);
        }
...
<body>
  ...
  <!-- <div id="open">open</div> -->
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
     ...
     <!-- form-section -->
     <div class="container login-form position-absolute"  id="form" style="z-index:1; left:20%;">
        <div class="row">
            ...
            <div class="form-section">
                ...
                <div class="col-6">
                    <div class="row">
                       <h3 class="text-center">Customer Support Helpline</h3>
        ...
        while ($mn = mysqli_fetch_assoc($query)) {
          ...
          <div class="col-6">
            <div class="card" style="background-color:gray; padding:30px;">
              <img id="pic1" style="height:400px;" src="upload/<?php echo $mn['file1']; ?>" alt=""
                class="img-fluid rounded">
              <img id="pic2" style="height:400px;" src="upload/<?php echo $mn['file2']; ?>" alt=""
                class="img-fluid rounded">
              <img id="pic3" style="height:400px;" src="upload/<?php echo $mn['file3']; ?>" alt=""
                class="img-fluid rounded">
            </div>
            <div class="row mt-3">
              <div class="col-4">
          ...
          <div class="col-5 offset-1 mt-5">
            ...
            <form action="add_to_cart.php" method="post">
              <input type="hidden" name="id" value="<?php echo $mn['id']; ?>" hidden>
    ...
    <div class="container-fluid footer-section">
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class=" col-lg-3">
            <h4>About Us</h4>
            <span>LapyWala Store in Bihar Sharif is One Of The leading Buisiness in the computer printer Dealers . Also
              Known For Computer Repair & Services, Laptop Laptop Dealers, computer Dealers.</span>
          </div>
          <div class=" col-lg-3">
            <h4>Quick Links</h4>
            <ul>
